...
def BMI():
    ...
    # you can change value, because different countries have different values
    if bmi <= 18.5:
        ...
        label3.config(text="It indicates that a persen is \n slightly overweight! \n A doctor may advise to loose some \n weight for healthy body.")
...
Button(root,text="View Report",width=15,height=2,font="arial 10 bold",bg="#42f5ec",fg="black",command=BMI).place(x=280,y=340)
